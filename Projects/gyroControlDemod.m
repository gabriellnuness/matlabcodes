% Closing the gyroscope loop with digital modulation signal.
% This script involke the simulink 'gyro4sim.slx'.
% The control is closed with a simple integrator block and uses the
% demodulated output to feedback the control signal.
clear all
close all
clc
...
step_time = tau/10         % Simulation step [s]
final_time = 2%tau*(6e5)       % Simulation final time [s]
